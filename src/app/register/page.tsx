...
import { X, User, Lock, Phone, ChevronRight, CheckCircle2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const { addUser } = useRegisteredUsers();
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-[420px] bg-black shadow-2xl overflow-hidden border border-gray-900 border-t-0 rounded-sm">
        ...
        <form onSubmit={handleRegister} className="p-8 space-y-6">
          {error && <div className="p-3 bg-red-500/10 text-red-500 border border-red-500/30 text-[11px] font-bold uppercase text-center rounded-sm">{error}</div>}
          ...
          <div className="space-y-1">
             ...
             <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white border-4 border-orange-500/30 ring-1 ring-orange-500 px-10 py-3 text-lg font-bold focus:outline-none focus:border-orange-500 focus:ring-orange-500 text-black rounded-sm"
          ...
          <div className="grid grid-cols-2 gap-3">
             <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full bg-white border-4 border-orange-500/30 ring-1 ring-orange-500 px-4 py-3 text-lg font-bold focus:outline-none focus:border-orange-500 focus:ring-orange-500 text-black rounded-sm"
                  placeholder="******"
                />
             </div>
             <div className="space-y-1">
        ...
        <div className="pt-4 border-t border-gray-900 text-center flex flex-col gap-2 p-4">
           <div>
